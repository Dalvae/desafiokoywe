...
export default function Home() {
  ...
  const [quoteResult, setQuoteResult] = useState<{ rate: number | null; convertedAmount: number | null }>({ rate: null, convertedAmount: null });
  ...
  const handleCreateQuote = async () => {
    try {
      ...
      setQuoteResult({ rate: quote.rate, convertedAmount: quote.convertedAmount });
    } catch (error: any) {
